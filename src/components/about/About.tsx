    ...
    return (
        <>
            <div className="w-full h-[624px] bg-black flex flex-row px-16">
                <div className="flex flex-row w-screen items-center max-h-[402px] mt-32">
            ...
            <div className="flex flex-col bg-black w-full px-16">
                <div className="w-1/2 border-2 border-red-500">
                    <img src="/about/pirate-polaroid.png" className="w-[250px]"/>
                </div>
            </div>
        </>
    )
