export default function About(){
    return (
        <div className="overflow-hidden relative bg-black ">
            <div className="absolute bottom-0 left-0 w-full h-[700px] bg-gradient-to-b from-black to-custom-blue opacity-60"></div>
            <div className="w-full h-[624px]  flex flex-row px-16 ">
                <div className="flex flex-row w-screen items-center max-h-[402px] mt-48">
                    <div className="flex flex-col min-h-[402px] justify-between">
                        ...
                        <p className="text-white text-[16px] leading-7 z-10">    
