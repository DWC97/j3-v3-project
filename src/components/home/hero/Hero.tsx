...
export default function Hero() {
    const { setActiveSection, scrollAnimation, setScrollAnimation } =
        ...
        <div ref={heroRef} className="h-screen w-full bg-black">
            <div className="section hero" id="hero">
                <div className="wrapper">
                    ...
                    />
                    <img
                        src="/hero/right-cliff.png"
                        alt="right cliff"
                        className="right-cliff parallax"
                        data-speedx="0.05"
                        data-speedy="0.043"
                        data-speedz="0.5"
                        data-rotation="0.13"
                    />
                    <img
                        src="/hero/middle-cliff.png"
                        alt="middle cliff"
                        className="middle-cliff parallax"
                        data-speedx="0.05"
                        data-speedy="0.042"
                        data-speedz="0.55"
                        data-rotation="0.14"
                    />
                    <div
                        className="text parallax w-full"
                        data-speedx="0.05"
                        data-speedy="0.05"
                        data-speedz="0.55"
                        data-rotation="0.14"
                    >
                        <h1
                            className="font-semibold main-heading"
                            ref={mainHeading}
                        >
                            JOLLY ROGER TOURS
                        </h1>
                        <h2
                            className="tracking-widest font-medium sub-heading"
                            ref={subHeading}
                        >
                    ...
                    <img
                        src="/hero/big-ship.png"
                        alt="ship"
                        className="big-ship parallax"
                        data-speedx="0.038"
                        data-speedy="0.038"
                        data-speedz="0.8"
                        data-rotation="0.2"
                    ...
                    />
                    <img
                        src="/hero/foliage.png"
                        alt="foliage"
                        className="foliage parallax"
                        data-speedx="0.01"
                        data-speedy="0.01"
                        data-speedz="0.8"
                        data-rotation="0.25"
                ...
                <div
                    className={`absolute w-full bottom-[30vh] ${scrollAnimation ? ' opacity-100' : 'opacity-0'}  left-0 flex justify-center items-center ease-in-out duration-1000`}
                >
                    <Lottie
