export default function Footer(){
    return (
        <div className="w-full h-[96px] bg-black flex flex-row justify-between items-center px-20 relative">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} viewBox="0 0 16 16"><path fill="white" d="m2.931 10.843l4.685-4.611a.546.546 0 0 1 .768 0l4.685 4.61a.55.55 0 0 0 .771 0a.53.53 0 0 0 0-.759l-4.684-4.61a1.65 1.65 0 0 0-2.312 0l-4.684 4.61a.53.53 0 0 0 0 .76a.55.55 0 0 0 .771 0"></path></svg>
        </div>
    )
}