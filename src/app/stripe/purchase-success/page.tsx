        ...
        <div className="w-full min-h-[90vh] bg-black flex justify-center">
            <div className="px-10 pt-40">
                <div className=" flex flex-row items-center">
                    <h1 className="font-bold text-white text-[32px] md:text-[40px]">
                        {isSuccess ? 'Booking Successful!' : 'Error!'}
                    </h1>
                    {isSuccess ? (
                        <svg
                ...
                {isSuccess ? (
                    <p className="text-white text-[16px] mb-10 mt-4">
                        You&apos;re all set! A booking confirmation has been
                        sent to{' '}
                        <span className="underline">{booking?.email}</span>
                    </p>
                ) : (
                    <p className="text-white text-[16px] mb-10 mt-4">
                        Looks like something went wrong... Click{' '}
                        <Link
                            className="text-custom-pink underline"
                            href={`/${tour.region}/booking`}
                        >
                            here
                        </Link>{' '}
                        to try again.
                ...
                <div className="w-full flex flex-col mt-20 pb-16">
                    <span className="text-white font-semibold text-[20px]">
                        Make sure you grab some of our merch for the trip!
                    </span>
