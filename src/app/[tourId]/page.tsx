        ...
        <div>
            {tour ? (
                <div className="bg-black -z-50 pb-8">
                    ...
                    {gallery.image && (
                        <div
                            className="fixed overflow-hidden top-0 left-0 h-screen w-full z-50 flex flex-col justify-center items-center focus:outline-none"
                            tabIndex={0}
                            ref={overlayRef}
                        ...
                        >
                            ...
                            <svg
                                ...
                                className="absolute top-5 right-5 cursor-pointer z-[900] hover:opacity-85 ease-in-out duration-300"
                                width={40}
                                height={40}
                                viewBox="0 0 24 24"
                            >
                            ...
                            <div
                                ref={domNode}
                                className="relative flex flex-row justify-center items-center z-50 h-[80%] max-w-[80%]  pb-16 mt-16"
                            >
                                {/* prev button */}
                                <div
                                    className="w-[80px] h-full bg-black ease-in-out duration-300 cursor-pointer bg-opacity-0 hover:bg-opacity-80 focus:bg-opacity-80 flex justify-center items-center focus:outline-none"
                                    tabIndex={0}
                                    ref={prevArrowRef}
                                    onClick={handlePrev}
                                ...
                                <div className="h-full max-w-full relative">
                                    <div className="h-[70vh] aspect-[4/3] max-w-[80vw] overflow-hidden relative">
                                        ...
                                        />
                                        <span className="absolute bottom-0 py-2 flex justify-center items-center text-gray-200 text-[16px] w-full bg-black bg-opacity-60">
                                            {tour?.captions?.[gallery.i] ??
                                        ...
                                        if (gallery.i === i) {
                                            ...
                                            return (
                                                <svg
                                                    ...
                                                    xmlns="http://www.w3.org/2000/svg"
                                                    className="z-[90] cursor-pointer ease-in-out duration-300"
                                                    width={20}
                                                    height={20}
                                                    viewBox="0 0 16 16"
                                                >
                    ...
                    <div className="w-full h-[400px] relative flex flex-col justify-end z-0">
                        ...
                        <div className="w-full h-1/2 flex flex-col justify-center z-10 px-10 xl:px-20 2xl:px-60">
                            <Reveal>
                                <h1 className="font-bold text-[40px] md:text-[56px] text-white tracking-wide">
                                    {tour?.region
                                        .toUpperCase()
                                        .replace('-', ' ')}
                                </h1>
                            ...
                            <Reveal>
                                <h2 className="text-[28px] md:text-[32px] text-gray-200 font-medium">
                    ...
                    <div className="px-10 xl:px-20 2xl:px-60">
                        <Link
                            href={'/#tours'}
                            className="mt-5 mb-10 bg-black flex flex-row items-center w-[230px] hover:opacity-85 ease-in-out duration-300"
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div className="w-full flex md:gap-0 gap-20 flex-col-reverse md:flex-row justify-between relative ">
                            <div className="flex flex-col md:mr-10">
                                <div className="text-white">
                                    ...
                                    <p className="text-[18px] text-gray-100 mb-4">
                                        {tour?.description1}
                                    </p>
                                ...
                                <Slide>
                                    <div
                                        className={`mt-10 mb-16 w-full  relative`}
                                    >
                                        <Image
                                            src={tour?.mapUrl ?? ''}
                                            alt="tour map"
                                ...
                                <div
                                    className={`w-full flex flex-col border-b border-gray-300 pb-4 `}
                                >
                                    <div
                                        className="w-full flex flex-row items-center relative cursor-pointer hover:opacity-85 ease-in-out duration-300"
                                        onClick={() =>
                                    ...
                                    >
                                        <h2 className="font-semibold text-[28px] sm:text-[36px] text-white pr-8">
                                            Activities
                                        </h2>
                                        <span className="text-[14px] text-gray-200 ml-10 hidden xl:block">
                                        ...
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className={`absolute right-0 ${answersVisible['activities'] && 'rotate-180'} `}
                                            width={32}
                                            height={32}
                                            viewBox="0 0 24 24"
                                        >
                                    ...
                                    <div
                                        className={`my-4 text-gray-200 text-[18px] -py-1 ${answersVisible['activities'] ? undefined : 'hidden'}`}
                                    >
                                        {tour?.activities?.map(
                                            (activity, i) => {
                                                return (
                                ...
                                <div className="w-full flex flex-col border-b border-gray-300 pb-4 mt-16">
                                    ...
                                    >
                                        <h3 className="font-semibold text-[28px] sm:text-[36px] text-white pr-8">
                                            What&apos;s included?
                                        </h3>
                                        <span className="text-[14px] hidden xl:block text-gray-200 ml-10">
                                        ...
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className={`absolute right-0 ${answersVisible['included'] && 'rotate-180'}`}
                                            width={32}
                                            height={32}
                                            viewBox="0 0 24 24"
                                        >
                                    ...
                                    <div
                                        className={`my-4 text-gray-200 text-[18px] -py-1 ${answersVisible['included'] ? undefined : 'hidden'}`}
                                    >
                                        <h3 className="font-semibold text-[20px] mb-2">
                                            TRAVEL
                                        </h3>
                                        {tour?.included?.travel.map(
                                            (activity, i) => {
                                                return (
                                                    <p key={i} className="py-1">
                                                        {activity}
                                        ...
                                        <h3 className="font-semibold text-[20px] mt-6 mb-2">
                                            ACCOMODATION
                                        </h3>
                                        {tour?.included?.accomodation.map(
                                            (activity, i) => {
                                                return (
                                                    <p key={i} className="py-1">
                                                        {activity}
                                ...
                                <div className="w-full flex flex-col border-b border-gray-300 pb-4 mt-16">
                                    ...
                                    >
                                        ...
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            className={`absolute right-0 ${answersVisible['needed'] && 'rotate-180'}`}
                                            width={32}
                                            height={32}
                                            viewBox="0 0 24 24"
                                        >
                                    ...
                                    <p
                                        className={`my-4 text-gray-200 text-[18px] ${answersVisible['needed'] ? undefined : 'hidden'}`}
                                    >
                                        {tour?.needed}
                                    </p>
                                </div>
                                {/* masonry gallery */}
                                <div className="mt-16">
                                    <h3 className="font-semibold text-[28px] sm:text-[36px] text-white mb-8">
                                        Gallery
                                    </h3>
                                        ...
                                        >
                                            ...
                                            >
                                                {tour?.gallery?.map(
                                                    (image, i) => (
                                                        <div
                                                            className="relative w-full h-full overflow-hidden hover:opacity-70 ease-in-out duration-300 cursor-pointer"
                                                            key={i}
                                                            onClick={() => {
                                                                viewImage(
                                                                    image,
                            ...
                            <div className="w-full md:w-[280px] lg:min-w-[400px] h-[815px] flex flex-col justify-between md:sticky -top-[220px] tall:-top-[80px] vtall:top-[60px]">
                                <div
                                    className="min-h-[700px] w-full border border-gray-500 rounded-lg relative overflow-hidden z-0"
                                    style={{
                                        backgroundImage:
                                            'url(' + tour.cardSrc + ')',
                                ...
                                >
                                    ...
                                    <div className="flex flex-col w-full p-5 h-[700px] justify-between ">
                                        <h3 className="font-semibold text-[36px] text-white z-30">
                                            Overview
                                        </h3>
                                        <ul className="w-full h-[450px] flex flex-col justify-between">
                                            ...
                                            {Object.entries(
                                                ...
                                                return (
                                                    <li
                                                        key={i}
                                                        className=" w-full flex flex-row justify-between text-[20px] lg:text-[20px] md:text-[16px] relative z-30"
                                                    >
                                                        <span className="font-medium text-white ">
                                                            {key}
                                                        </span>
                                                        ...
                                                        <div
                                                            className="hidden sm:block md:hidden lg:block absolute w-[150px] sm:left-[250px] lg:left-[145px] top-[10px] h-[12px] rounded-r-md"
                                                            style={{
                                                                backgroundColor:
                                                                    colorGenerator(
                                                                        val
                                        ...
                                        <div className="w-full h-[90px] flex flex-row justify-between">
                                            <span className="font-medium text-[20px] lg:text-[20px] md:text-[16px] text-white z-30">
                                                Price
                                            </span>
                                            <span className="font-semibold text-[36px]  lg:text-[52px] text-white tracking-wide pt-8 lg:pt-0 z-30">
                                                {tour &&
                                ...
                                <Link href={`/${params.tourId}/booking`}>
