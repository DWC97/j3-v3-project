...
export default function CheckoutForm({ tour, clientSecret }){
    return (
        <div className="pb-20">
            ...
            <div className="w-full h-[180px] bg-gradient-to-r from-custom-orange to-custom-pink p-[2px] rounded-2xl">
                <div className="bg-black w-full h-full rounded-2xl flex flex-row justify-between overflow-hidden">
                    ...
                    <div className="flex flex-col justify-center">
                        <h1 className="text-white text-[28px] font-semibold">{tour.region.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1).toLowerCase()).join(' ')}</h1>
                    ...
                    <div className="flex flex-col pr-8 pt-8 pl-16">
                        <Link href={`/${tour.destination}`} className=" bg-black flex flex-row items-center hover:opacity-85 ease-in-out duration-300">
